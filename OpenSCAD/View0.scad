                        ...
                        rotate([0.0, 180.0, 0.0])
                        {
                            translate([150.0, 0.0, 0.0])
                            {
                                difference()
                                {
                                    ...
                                    linear_extrude(height = 13.0, twist = 0.0, scale = 1.0, slices = 1, center = false)
                                    {
                                        scale([88.0, 58.0])
                                        {
                                            M8();
