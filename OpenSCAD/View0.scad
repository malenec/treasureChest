union()
{
    union()
    {
        ...
        translate([-43.375, 31.935, 56.3])
        {
            difference()
            {
                linear_extrude(height = 8.7, twist = 0.0, scale = 1.0, slices = 1, center = false)
                {
                    scale([15.45, 8.33])
                    {
                        M8();
                ...
                {
                    linear_extrude(height = 6.7, twist = 0.0, scale = 1.0, slices = 1, center = false)
                    {
                        scale([13.25, 6.13])
                        {
                            M8();
