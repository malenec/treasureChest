union()
{
    union()
    {
        difference()
        {
            difference()
            {
                ...
                {
                    linear_extrude(height = 62.5, twist = 0.0, scale = 1.0, slices = 1, center = false)
                    {
                        scale([100.0, 70.0])
                        {
                            M8();
        ...
        translate([-43.375, 31.935000000000002, 57.2])
        {
            difference()
            {
                linear_extrude(height = 7.8, twist = 0.0, scale = 1.0, slices = 1, center = false)
                {
                    scale([15.45, 8.33])
                    {
                        M8();
                ...
                {
                    linear_extrude(height = 6.699999999999999, twist = 0.0, scale = 1.0, slices = 1, center = false)
                    {
                        scale([13.25, 6.13])
                        {
                            M8();
                ...
                linear_extrude(height = 1.1, twist = 0.0, scale = 1.0, slices = 1, center = false)
                {
                    scale([13.25, 2.0])
                    {
                        M8();
    ...
    translate([0.0, 75.95, 0.0])
    {
        translate([0.0, 0.0, 99.5])
        {
            rotate([90.0, 0.0, 0.0])
            {
                rotate([0.0, 0.0, 180.0])
                {
                    union()
                    {
                        ...
                        translate([46.4125, 31.384999999999998, 32.5])
                        {
